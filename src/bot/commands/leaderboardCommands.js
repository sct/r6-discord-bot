...
export const commandShowLeaderboard = async function commandShowLeaderboard(
  message,
  type
) {
  try {
...
export const commandTrackPlayer = async function commandTrackPlayer(
  message,
  playerName
) {
  try {
    ...
    return message.channel.send(
      "Player does not exist. Did you spell it wrong?"
    );
  }
};

export const commandUntrackPlayer = async function commandUntrackPlayer(
  message,
  playerName
) {
  try {
